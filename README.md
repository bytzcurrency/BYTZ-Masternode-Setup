...
This guide will assist you in setting up a BYTZ Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)
...
`wget -q https://github.com/bytzcurrency/slate-mn-setup/blob/bytz-masternode/bytz_install.sh`
***
